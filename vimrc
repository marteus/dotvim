...
augroup omnisharp_commands
    ...
    autocmd FileType cs nnoremap <C-j> :OmniSharpNavigateUp<cr> "navigate up by method/property/field
    autocmd FileType cs nnoremap <C-k> :OmniSharpNavigateDown<cr> "navigate down by method/property/field
